...
export default class Buttons extends React.Component {
    ...
    handlePower() {
        this.props.socket.emit(this.props.state_ll === "off" ? "turn_on" : "turn_off", "");
    }
	...
	render() {
		const classes = "btn-floating btn-large waves-effect waves-light " + this.button_colors[this.props.state_ll] + " command-button";
		var cupButton1, cupButton2;
		if (this.props.state_ll !== "no_water") {
			cupButton1 =
